//! File monitoring for legal-safe Instagram export directories.
...
/// File system event types emitted by the Instagram monitor.
...
/// File monitoring configuration for Instagram exports.
#[derive(Debug, Clone)]
...
/// File system monitor for Instagram export trees.
...
impl FileMonitor {
    ...
    pub fn new(config: FileMonitorConfig) -> Result<Self, InstagramError> {
    ...
    /// Start monitoring.
    pub fn start(&mut self) -> Result<(), InstagramError> {
    ...
    /// Stop monitoring.
    pub fn stop(&mut self) -> Result<(), InstagramError> {
    ...
    /// Default path patterns for Instagram export and media folders.
    pub fn instagram_export_patterns() -> Vec<Regex> {
        vec![
