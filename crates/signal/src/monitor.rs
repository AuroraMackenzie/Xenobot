//! File monitoring for legal-safe Signal export directories.
...
/// File system event types emitted by the Signal monitor.
...
/// File monitoring configuration for Signal exports.
#[derive(Debug, Clone)]
...
/// File system monitor for Signal export trees.
...
impl FileMonitor {
    ...
    pub fn new(config: FileMonitorConfig) -> Result<Self, SignalError> {
    ...
    /// Start monitoring.
    pub fn start(&mut self) -> Result<(), SignalError> {
    ...
    /// Stop monitoring.
    pub fn stop(&mut self) -> Result<(), SignalError> {
    ...
    /// Default path patterns for Signal export and media folders.
    pub fn signal_export_patterns() -> Vec<Regex> {
        vec![
...
mod tests {
    ...
    fn export_patterns_match_common_assets() {
        let patterns = FileMonitor::signal_export_patterns();
