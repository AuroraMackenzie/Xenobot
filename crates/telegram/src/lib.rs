...
/// Common result type used by Telegram crate operations.
pub type TelegramResult<T> = Result<T, TelegramError>;

pub use config::TelegramConfig;
pub use service::{AuthorizedTelegramWorkspace, StagedTelegramExport, TelegramService};
