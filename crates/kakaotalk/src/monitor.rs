//! File monitoring for legal-safe KakaoTalk export directories.
...
use crate::KakaoTalkError;

/// File system event types emitted by the KakaoTalk monitor.
...
/// File monitoring configuration for KakaoTalk exports.
#[derive(Debug, Clone)]
...
/// File system monitor for KakaoTalk export trees.
...
impl FileMonitor {
    ...
    pub fn new(config: FileMonitorConfig) -> Result<Self, KakaoTalkError> {
    ...
    /// Start monitoring.
    pub fn start(&mut self) -> Result<(), KakaoTalkError> {
    ...
    /// Stop monitoring.
    pub fn stop(&mut self) -> Result<(), KakaoTalkError> {
    ...
    /// Default path patterns for KakaoTalk export and media folders.
    pub fn kakaotalk_export_patterns() -> Vec<Regex> {
        vec![
...
mod tests {
    ...
    fn export_patterns_match_common_assets() {
        let patterns = FileMonitor::kakaotalk_export_patterns();
