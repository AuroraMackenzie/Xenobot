//! File monitoring for legal-safe Slack export directories.
...
/// File system event types emitted by the Slack monitor.
...
/// File monitoring configuration for Slack exports.
#[derive(Debug, Clone)]
...
/// File system monitor for Slack export trees.
...
impl FileMonitor {
    ...
    pub fn new(config: FileMonitorConfig) -> Result<Self, SlackError> {
    ...
    /// Start monitoring.
    pub fn start(&mut self) -> Result<(), SlackError> {
    ...
    /// Stop monitoring.
    pub fn stop(&mut self) -> Result<(), SlackError> {
    ...
    /// Default path patterns for Slack export and media folders.
    pub fn slack_export_patterns() -> Vec<Regex> {
        vec![
...
mod tests {
    ...
    fn export_patterns_match_common_assets() {
        let patterns = FileMonitor::slack_export_patterns();
