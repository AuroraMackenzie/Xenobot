//! File monitoring for legal-safe Messenger export directories.
...
/// File system event types emitted by the Messenger monitor.
...
/// File monitoring configuration for Messenger exports.
#[derive(Debug, Clone)]
...
/// File system monitor for Messenger export trees.
...
impl FileMonitor {
    ...
    pub fn new(config: FileMonitorConfig) -> Result<Self, MessengerError> {
    ...
    /// Default path patterns for Messenger export and media folders.
    pub fn messenger_export_patterns() -> Vec<Regex> {
        vec![
...
mod tests {
    ...
    fn export_patterns_match_common_assets() {
        let patterns = FileMonitor::messenger_export_patterns();
