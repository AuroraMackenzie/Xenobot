//! File monitoring for legal-safe Viber export directories.
...
use crate::ViberError;

/// File system event types emitted by the Viber monitor.
...
/// File monitoring configuration for Viber exports.
#[derive(Debug, Clone)]
...
/// File system monitor for Viber export trees.
...
impl FileMonitor {
    ...
    pub fn new(config: FileMonitorConfig) -> Result<Self, ViberError> {
    ...
    /// Start monitoring.
    pub fn start(&mut self) -> Result<(), ViberError> {
    ...
    /// Stop monitoring.
    pub fn stop(&mut self) -> Result<(), ViberError> {
    ...
    /// Default path patterns for Viber export and media folders.
    pub fn viber_export_patterns() -> Vec<Regex> {
        vec![
...
mod tests {
    ...
    fn export_patterns_match_common_assets() {
        let patterns = FileMonitor::viber_export_patterns();
