...
pub fn transcode_audio_to_mp3(
    ...
    let output = Command::new(binary)
        ...
        .output()
        .map_err(|error| GoogleChatError::Internal(anyhow::anyhow!("failed to start ffmpeg: {}", error)))?;
...
pub fn transcode_audio_bytes_to_mp3(
    ...
    if input_bytes.is_empty() {
        return Err(GoogleChatError::Internal(anyhow::anyhow!("input audio payload is empty")));
    }
