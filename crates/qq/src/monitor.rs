//! File monitoring for legal-safe QQ export directories.
...
/// File monitoring configuration for QQ exports.
#[derive(Debug, Clone)]
...
/// File system monitor for QQ export trees.
...
impl FileMonitor {
    ...
    pub fn new(config: FileMonitorConfig) -> Result<Self, QQError> {
    ...
    /// Start monitoring.
    pub fn start(&mut self) -> Result<(), QQError> {
    ...
    /// Stop monitoring.
    pub fn stop(&mut self) -> Result<(), QQError> {
    ...
    /// Default path patterns for QQ export and media folders.
    pub fn qq_export_patterns() -> Vec<Regex> {
        vec![
