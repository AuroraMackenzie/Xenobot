...
const { activeNav, scrollContainerRef, setSectionRef, handleNavChange } =
  useSubTabsScroll(navItems);
void scrollContainerRef;

const storageManageRef = ref<InstanceType<typeof StorageManageSection> | null>(
  null,
);
...
<template>
  <div class="flex h-full gap-6">
    ...
    <div
      ...
      class="xeno-storage-shell min-w-0 flex-1 overflow-y-auto rounded-2xl p-5"
    >
      <div class="space-y-8">
