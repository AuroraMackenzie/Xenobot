...
<template>
  <UModal
    ...
    :ui="{
      overlay: 'app-region-no-drag',
      content: 'md:w-full max-w-5xl app-region-no-drag',
    }"
  ...
  >
    <template #content>
      <div class="xeno-setting-shell p-6">
        <!-- Header -->
        <div
          class="xeno-setting-header mb-4 flex items-center justify-between gap-4"
        >
          <div class="min-w-0">
            <h2
