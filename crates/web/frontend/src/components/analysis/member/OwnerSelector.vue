...
const hintText = computed(() => {
  if (currentOwner.value) {
    return t("members.ownerSelector.currentOwner", {
      name: getDisplayName(currentOwner.value),
    });
  }
...
<template>
  <div
    class="w-150 rounded-lg border border-gray-200 bg-white p-3 shadow-sm dark:border-gray-700 dark:bg-gray-900"
  >
