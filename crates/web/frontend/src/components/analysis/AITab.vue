  ...
  <div class="flex h-full flex-col">
    ...
    <div class="flex-1 min-h-0 overflow-hidden">
      <Transition name="fade" mode="out-in">
        ...
        <!-- English UI note -->
        <SQLLabTab
          v-else-if="activeSubTab === 'sql-lab'"
          class="h-full"
        ...
        >
          ...
          >
            <div class="text-center">
              <UIcon
                :name="subTabs.find((t) => t.id === activeSubTab)?.icon"
              ...
              <p class="mt-1 max-w-md px-4 text-sm text-gray-500">
                {{
                  subTabs.find((tab) => tab.id === activeSubTab)?.desc ||
                  t("ai.tab.comingSoon")
                }}
              </p>

              <div
                class="mt-8 flex items-center justify-center gap-1 text-xs text-gray-400"
              >
