...
<template>
  ...
  >
    <template #content>
      <div
        class="agreement-modal xeno-agreement-shell flex max-h-[85vh] flex-col p-6"
      >
        <!-- Header -->
        <div
          class="xeno-agreement-header mb-4 flex items-center justify-between gap-3"
        >
          <div class="flex items-center gap-3">
            ...
            <div class="min-w-0">
              <h2
                class="break-words text-xl font-bold text-gray-900 dark:text-white"
              >
                {{ t("common.agreement.title") }}
              </h2>
              <p class="text-sm text-gray-500 dark:text-gray-400">
                {{ t("common.agreement.subtitle") }}
              </p>
            </div>
          </div>
        ...
        <div
          class="xeno-agreement-content-wrap mb-6 flex-1 overflow-y-auto pr-4"
        >
          <div class="agreement-content" v-html="renderedContent" />
        </div>

        <div
          class="xeno-agreement-footer flex items-center justify-end gap-3 pt-4"
        >
          <UButton
            variant="ghost"
            color="neutral"
