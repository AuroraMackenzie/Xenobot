...
.xeno-app-shell::before {
  ...
  opacity: 0;
  background:
    radial-gradient(circle at 16% 8%, var(--xeno-cosmos-blue), transparent 40%),
    radial-gradient(
      circle at 82% 88%,
      var(--xeno-cosmos-amber),
      transparent 22%
    );
}
...
.xeno-app-shell::after {
  ...
  background:
    ...
    radial-gradient(circle at 78% 18%, var(--xeno-cosmos-cyan), transparent 28%);
  opacity: 0.34;
}
