//! File monitoring for legal-safe Zoom export directories.
...
/// File system event types emitted by the Zoom monitor.
...
/// File monitoring configuration for Zoom exports.
#[derive(Debug, Clone)]
...
/// File system monitor for Zoom export trees.
...
impl FileMonitor {
    ...
    pub fn new(config: FileMonitorConfig) -> Result<Self, ZoomError> {
    ...
    /// Start monitoring.
    pub fn start(&mut self) -> Result<(), ZoomError> {
    ...
    /// Stop monitoring.
    pub fn stop(&mut self) -> Result<(), ZoomError> {
    ...
    /// Default path patterns for Zoom export and media folders.
    pub fn zoom_export_patterns() -> Vec<Regex> {
        vec![
...
mod tests {
    ...
    fn export_patterns_match_common_assets() {
        let patterns = FileMonitor::zoom_export_patterns();
