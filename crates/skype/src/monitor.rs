//! File monitoring for legal-safe Skype export directories.
...
use crate::SkypeError;

/// File system event types emitted by the Skype monitor.
...
/// File monitoring configuration for Skype exports.
#[derive(Debug, Clone)]
...
/// File system monitor for Skype export trees.
...
impl FileMonitor {
    ...
    pub fn new(config: FileMonitorConfig) -> Result<Self, SkypeError> {
    ...
    /// Start monitoring.
    pub fn start(&mut self) -> Result<(), SkypeError> {
    ...
    /// Stop monitoring.
    pub fn stop(&mut self) -> Result<(), SkypeError> {
    ...
    /// Default path patterns for Skype export and media folders.
    pub fn skype_export_patterns() -> Vec<Regex> {
        vec![
...
mod tests {
    ...
    fn export_patterns_match_common_assets() {
        let patterns = FileMonitor::skype_export_patterns();
