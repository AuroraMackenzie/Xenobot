//! File monitoring for legal-safe Teams export directories.
...
use crate::TeamsError;

/// File system event types emitted by the Teams monitor.
...
/// File monitoring configuration for Teams exports.
#[derive(Debug, Clone)]
...
/// File system monitor for Teams export trees.
...
impl FileMonitor {
    ...
    pub fn new(config: FileMonitorConfig) -> Result<Self, TeamsError> {
    ...
    /// Start monitoring.
    pub fn start(&mut self) -> Result<(), TeamsError> {
    ...
    /// Stop monitoring.
    pub fn stop(&mut self) -> Result<(), TeamsError> {
    ...
    /// Default path patterns for Teams export and media folders.
    pub fn teams_export_patterns() -> Vec<Regex> {
        vec![
...
mod tests {
    ...
    fn export_patterns_match_common_assets() {
        let patterns = FileMonitor::teams_export_patterns();
